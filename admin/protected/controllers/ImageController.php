...
class ImageController extends Controller
{
	...
	public function actionUpload($advertiser_id)
	{
		$model = new Image;
		$keyword = new Keyword;
		$advertiser = Advertiser::model()->findByPk($advertiser_id);
		if (isset($_POST['Image']))
		{
			...
			if($model->save())
            { 
                $model->image_uri->saveAs('images/'.$advertiser_id.'-'.$model->image_uri);  // PATH IMAGES
				$this->redirect(array('advertiser/_upload','model'=>$advertiser,'keyword'));
			}
		}
